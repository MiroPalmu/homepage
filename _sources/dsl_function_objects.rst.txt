...
In this blog post I'm going to describe metaprogramming technique that arose when
...
For example we define simple language which just controls which argument types are
...
UDL for this DSL function object is ``""_p``. Example usage ``"ABBCCC"_p(A{1}, B{2}, B{3}, C{4}, C{5}, C{6});``
...
of argument could be as complex as one desires.
